...
sub exmovies {
    ...
    my $xlabel = "x";
    my $ylabel = "y";
    my $movname = $exdir."ex".$exnum."_allmovies-2D.mpg";
    ...
    my $fnumber = 3;
    my $title = "Density";
    $movname = $exdir."ex".$exnum."_density-2D.mpg";
    ...
    $fnumber = 4;
    $title = "X-Velocity";
    $movname = $exdir."ex".$exnum."_x-velocity-2D.mpg";
    ...
    $fnumber = 5;
    $title = "Y-Velocity";
    $movname = $exdir."ex".$exnum."_y-velocity-2D.mpg";
...
#     $fnumber = 6;
#     $title = "Z-Velocity";
#     $movname = $exdir."ex".$exnum."_z-velocity-2D.mpg";
...
#                   $fnumber, $movname, $exdir, $ndump, @times);
    ...
    $movname = $exdir."ex".$exnum."_x-mag_field-2D.mpg";
    ...
    $movname = $exdir."ex".$exnum."_y-mag_field-2D.mpg";
...
#     $movname = $exdir."ex".$exnum."_z-mag_field-2D.mpg";
...
#                   $fnumber, $movname, $exdir, $ndump, @times);
    ...
    $fnumber = 10;
    $title = "Pressure";
    $movname = $exdir."ex".$exnum."_pressure-2D.mpg";
    ...
    $fnumber = 11;
    $title = "divB";
    $movname = $exdir."ex".$exnum."_divB-2D.mpg";
    ...
    $fnumber = 12;
    $title = "Current";
    $movname = $exdir."ex".$exnum."_current-2D.mpg";
