function [A,stencil,nx,ny,nz] = read_HypreSStructMat(matfile)

% Usage: [A,stencil,nx,ny,nz] = read_HypreSStructMat('matfile')
% 
...
%
% Outputs:
%       A - sparse matrix containing the specified HYPRE SStruct matrix
